...
/**
 * Resolves the OpenAI API key: an admin-configured key (Settings, stored
 * encrypted at rest via APP_KEY) takes precedence over the OPENAI_API_KEY
 * env var, so the key can be managed without redeploying.
 */
class OpenAiConfig
{
    public static function apiKey(): ?string
    {
        $encrypted = Setting::get('openai_api_key', '');
    ...
    {
        Setting::set('openai_api_key', Crypt::encryptString($plainTextKey));
    }
