...
@section('content')
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-semibold text-forest-900">{{ $isEdit ? 'Region bearbeiten: '.$region->name : 'Neue Region erstellen' }}</h1>
        @if ($isEdit)
            <a href="{{ route('admin.regions.preview', $region) }}" target="_blank" class="text-sm font-semibold text-forest-600 hover:text-forest-900">Vorschau ansehen &rarr;</a>
        @endif
    </div>
